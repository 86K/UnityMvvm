...
namespace Fusion.Mvvm
{
    public class Localization : ILocalization
    {
        ...
        public Task AddDataProvider(LocalizationSourceBehaviour.MultilingualSourceDataProvider provider)
        {
        ...
        public virtual void RemoveDataProvider(LocalizationSourceBehaviour.MultilingualSourceDataProvider provider)
        {
            if (provider == null)
                return;
